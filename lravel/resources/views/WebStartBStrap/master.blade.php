...
<html lang="en">
    <head>
        ...
        <link href="{{URL::asset('resources/vendor/css/styles.css')}}" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Header-->
       @include('\WebStartBStrap\header');
        <!-- Masthead-->
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image-->
                <img class="masthead-avatar mb-5" src="{{URL::asset('resources/vendor/assets/img/avataaars.svg')}}" alt="..." />
                <!-- Masthead Heading-->
        ...
        <!-- Contact Section-->
       @include('\WebStartBStrap\contact');
        <!-- Footer-->
       @include('\WebStartBStrap\footer');
        <!-- Copyright Section-->
       @include('\WebStartBStrap\copyright')
        <!-- Portfolio Modal 2-->
